...
- legacy shell behavior is still concentrated in
  [`pycodeagent/tools/builtin/bash.py`](../pycodeagent/tools/builtin/bash.py)
- legacy patch behavior is still concentrated in
  [`pycodeagent/tools/builtin/patch.py`](../pycodeagent/tools/builtin/patch.py)
...
Step B should extract the pure patch-application core out of
[`pycodeagent/tools/builtin/patch.py`](../pycodeagent/tools/builtin/patch.py)
into `pycodeagent/tools/patch_apply.py`.
