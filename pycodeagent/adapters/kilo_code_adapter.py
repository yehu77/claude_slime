"""Raw-artifact capture adapter for Kilo Code style CLIs."""
...
class KiloCodeAdapter(ExternalCliArtifactAdapter):
    """Subprocess adapter that captures raw artifacts from Kilo Code wrappers."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            command_prefix=command_prefix or ["kilo"],
