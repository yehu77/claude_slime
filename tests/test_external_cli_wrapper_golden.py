"""Golden snapshot test for a real external wrapper smoke bundle."""
...
_FIXTURE_DIR = Path("tests/fixtures/external_cli_claude_wrapper_bundle")
_TEST_NAMESPACE = "external_cli_wrapper_golden"
_RUN_ID = "claude_wrapper_smoke_004"
...
class TestExternalCliClaudeWrapperGolden:
    def test_wrapper_smoke_bundle_matches_fixture(self) -> None:
        ...
        try:
            ...
            assert _normalize_value(
                _load_json(run_dir / "tool_catalog.json"),
                repo_root=repo_root,
                run_dir=run_dir,
                workspace_dir=workspace_dir,
            ) == _load_json(_FIXTURE_DIR / "tool_catalog.json")
