...
class TestSchemaCandidate:
    ...
    def test_from_dict_with_adapter_mapping(self):
        ...
        assert candidate.category == "schema_flat_to_nested"
    ...
    def test_invalid_category_raises(self):
        with pytest.raises(SchemaMutationError, match="category"):
            SchemaCandidate(
                input_schema=_BASE_SCHEMA,
                adapter={},
    ...
    def test_supported_categories_constant_is_stable(self):
        assert SCHEMA_VARIANT_CATEGORIES == {
            "argument_rename",
