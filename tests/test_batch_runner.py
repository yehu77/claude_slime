...
class TestBatchRunnerWithMockedTask:
    ...
    def test_single_task_single_profile(self, monkeypatch):
        ...
        traj = _make_completed_trajectory(task_id="t1", passed=True, reward=1.0)

        def mock_run_coding_task(task, client, output_dir, *, profile=None, runtime=None):
            return traj
    ...
    def test_single_task_multiple_profiles(self, monkeypatch):
        ...
        traj = _make_completed_trajectory(task_id="t1", passed=True)
    ...
    def test_multiple_tasks_single_profile(self, monkeypatch):
        ...
        def mock_run_coding_task(task, client, output_dir, *, profile=None, runtime=None):
            return _make_completed_trajectory(task_id=task.task_id)
    ...
    def test_metrics_in_result(self, monkeypatch):
        ...
        traj = _make_completed_trajectory(passed=True, reward=1.0)
