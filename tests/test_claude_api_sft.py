...
from tests.test_claude_api_trace_extract import _make_request
...
class TestClaudeApiSFT:
    ...
    def test_serialized_and_prepared_sample_train_only_selected_blocks(self) -> None:
        ...
        assert serialized.segments[-2].trainable is True
        ...
        assert trainable_segments == ["assistant", "assistant_tool_call"]
