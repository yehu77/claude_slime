...
# Minimal offline training smoke script for pycodeagent-prepared bundles.
#
# Edit these paths before running inside the slime Docker container:
# - CODEX_REPO: mounted claude_slime repo
...
MODEL_HF_DIR="${MODEL_HF_DIR:-/models/Qwen3-4B}"
MODEL_TORCH_DIST_DIR="${MODEL_TORCH_DIST_DIR:-/models/Qwen3-4B_torch_dist}"
PREPARED_BUNDLE_DIR="${PREPARED_BUNDLE_DIR:-${CODEX_REPO}/runs/training_prep/schema_failure_attribution_v1_mimo_v25pro}"
TRAIN_OUTPUT_DIR="${TRAIN_OUTPUT_DIR:-/runs/slime_qwen3_4b_pycodeagent}"
